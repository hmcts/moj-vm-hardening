...
packages=( az azcopy docker docker-compose dotnet eslint gcc git google-chrome gulp java /usr/lib/jvm/java-17-openjdk-amd64/bin/java make node npm psql ruby rsync sonar-scanner terraform tfcmt tfenv virtualenv yarn wget jq)
