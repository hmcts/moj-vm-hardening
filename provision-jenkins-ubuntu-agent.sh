...
export HELM_VERSION=$(echo v3.15.2 | tr -d 'v')
...
export SONAR_SCANNER_VERSION=$(echo 6.0.0.4432 | tr -d 'v')
#renovate: datasource=github-tags depName=hashicorp/terraform
export TF_VERSION=$(echo v1.9.0 | tr -d 'v')
#renovate: datasource=github-tags depName=suzuki-shunsuke/tfcmt
export TFCMT_VERSION=$(echo v4.10.0 | tr -d 'v')
